        ...
        a: {
          ...
          if (
            ...
            if ("function" === typeof children$jscomp$0[ASYNC_ITERATOR]) {
              ...
              if (_iterator) {
                validateAsyncIterable(task, children$jscomp$0, -1, _iterator);
                var prevThenableState = task.thenableState;
                task.thenableState = null;
                thenableIndexCounter = 0;
                thenableState = prevThenableState;
  ...
  iterator !== iterable ||
    (-1 === childIndex &&
      ...
      "[object AsyncGeneratorFunction]" ===
        Object.prototype.toString.call(task.componentStack.type) &&
      "[object AsyncGenerator]" === Object.prototype.toString.call(iterator)) ||
    (didWarnAboutGenerators ||
      console.error(
    ...
    if (!(0 < request.pendingRootTasks)) {
      ...
      for (i = 0; i < clientRenderedBoundaries.length; i++) {
        ...
        var resumableState$jscomp$1 = request.resumableState,
          ...
          scriptFormat =
            resumableState$jscomp$1.streamingFormat === ScriptStreamingFormat;
        scriptFormat
          ? (writeChunk(
        ...
        var JSCompiler_inline_result = scriptFormat
          ? !!renderState$jscomp$1.write(clientRenderScriptEnd)
          : !!renderState$jscomp$1.write(clientRenderDataEnd);
...
var isomorphicReactPackageVersion$jscomp$inline_804 = React.version;
if (
  "19.3.0-experimental-408b38ef-20251023" !==
  isomorphicReactPackageVersion$jscomp$inline_804
)
  throw Error(
    'Incompatible React versions: The "react" and "react-dom" packages must have the exact same version. Instead got:\n  - react:      ' +
      (isomorphicReactPackageVersion$jscomp$inline_804 +
        "\n  - react-dom:  19.3.0-experimental-408b38ef-20251023\nLearn more: https://react.dev/warnings/version-mismatch")
  );
